...

  {
    ...
    config = function()
      require('neo-tree').setup {
        vim.keymap.set('n', '<leader>e', '<cmd>Neotree float toggle<cr>', { desc = 'Toggle explorer' })
      }
    end,
  },
...
vim.keymap.set('n', '<leader>C', '<cmd>:%bd|e#<cr>', { desc = 'Close other buffers' })
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'bash', 'c', 'cpp',
    'dockerfile', 'go', 'gomod', 'gosum',
    'json', 'lua', 'markdown', 'python',
    'rust', 'sql', 'terraform', 'toml', 'tsx',
    'typescript', 'vimdoc',
    'vim', 'yaml' },
