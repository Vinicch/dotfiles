...
require("nvim-treesitter").install({
    "bash", "css", "cpp", "dockerfile", "go", "gomod", "html", "javascript", "json",
    "python", "regex", "rust", "sql", "terraform", "toml", "typescript", "tsx", "yaml"
})

require("lazydev").setup()
require("mason").setup()
require("mason-lspconfig").setup({
    ensure_installed = { "clangd", "cssls", "gopls", "html", "lua_ls", "rust_analyzer", "ts_ls" }
})
